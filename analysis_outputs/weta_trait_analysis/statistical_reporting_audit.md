...
- Original-model sensitivity: five instar/sex regressions reproduce coefficients, intervals, sample sizes, direct coefficient comparisons, percentage changes and three Holm families.
- Final flexible contrasts independently reproduce GLS estimates, analytic Welch-Satterthwaite df, intervals, Holm tests and recorded sample assignments; wide and long tables agree.
