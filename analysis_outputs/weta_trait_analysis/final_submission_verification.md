...
## Terminology update on 24 September 2026

The manuscript and supplement now define “rank-one (single-axis) approximation” at first mention and use “single-axis” thereafter, including table labels. Numerical text and inline calculations were unchanged by this edit. The manuscript retained the existing measurement-repeatability Results paragraph. Both Word documents were regenerated and checked; the terminology change required no new analyses.
