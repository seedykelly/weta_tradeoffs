...
transformed parameters {
  ...
  lprior += normal_lpdf(b_fore[9] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_fore[10] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_fore[11] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_fore[12] | 0, 1 * prior_scale);
  ...
  lprior += normal_lpdf(b_mid[9] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_mid[10] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_mid[11] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_mid[12] | 0, 1 * prior_scale);
  ...
  lprior += normal_lpdf(b_hind[9] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_hind[10] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_hind[11] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_hind[12] | 0, 1 * prior_scale);
  ...
  lprior += normal_lpdf(b_earlin[9] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_earlin[10] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_earlin[11] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_earlin[12] | 0, 1 * prior_scale);
  ...
  lprior += normal_lpdf(b_eye[9] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_eye[10] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_eye[11] | 0, 1 * prior_scale);
  lprior += normal_lpdf(b_eye[12] | 0, 1 * prior_scale);
